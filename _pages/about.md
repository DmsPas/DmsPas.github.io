...
<!-- Background video -->
<video autoplay muted loop playsinline style="position: absolute; top: 0; left: 0; min-width: 100%; min-height: 100%; object-fit: cover; z-index: -1; opacity: 0.2;">
  <source src="/files/Background.mov" type="video/mp4">
  Your browser does not support the video tag.
</video>

<!-- Main content -->
<div style="position: relative; z-index: 1; padding: 20px; background-color: rgba(255, 255, 255, 0.8); border-radius: 10px;">
  <h1>About Me</h1>
